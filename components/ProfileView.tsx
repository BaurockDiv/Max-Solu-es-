            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="p-5 bg-zinc-50 dark:bg-zinc-950 rounded-[1.8rem] space-y-4 border border-zinc-100 dark:border-zinc-900">
                <div className="flex items-start space-x-3">
                  <div className="w-9 h-9 rounded-lg bg-white dark:bg-black flex items-center justify-center text-zinc-400 border border-zinc-100 dark:border-zinc-800"><MapPin size={16} /></div>
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-9 h-9 rounded-lg bg-white dark:bg-black flex items-center justify-center text-zinc-400 border border-zinc-100 dark:border-zinc-800"><Clock size={16} /></div>
              ...
              <div className="space-y-2.5">
                ...
                {business.links && business.links.length > 0 ? business.links.map((link, idx) => (
                  <a key={idx} href={link.url} className="flex items-center justify-between p-3.5 bg-white dark:bg-black rounded-xl border border-zinc-100 dark:border-zinc-900 group shadow-sm active:scale-[0.98] transition-all">
                    <div className="flex items-center space-x-3">
                      <div className="w-8 h-8 rounded-lg bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center text-blue-600"><Globe size={16} /></div>
