...
const FollowingView: React.FC<FollowingViewProps> = ({ onProfileClick }) => {
  ...
  if (loading) return (
    <div className="h-full flex flex-col items-center justify-center bg-black gap-4">
      ...
      <p className="text-[10px] font-black uppercase text-zinc-600 tracking-widest">Sincronizando Seguindo...</p>
    </div>
  );
    ...
    return (
      <div className="h-full bg-black flex flex-col items-center justify-center p-10 text-center space-y-6">
        ...
        <div className="space-y-2">
           <h2 className="text-xl font-black text-white uppercase tracking-tight">Seguindo Vazio</h2>
    ...
    <div className="h-full flex flex-col bg-black">
      ...
      <div className="bg-black/80 backdrop-blur-xl pt-12 pb-4 border-b border-zinc-900">
        <div className="px-6 flex items-center justify-between mb-4">
           <h1 className="text-xl font-black text-white uppercase tracking-tighter">Seguindo</h1>
